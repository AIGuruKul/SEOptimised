...
class SimpleBlogContentGenerator:
    ...
    def generate_blog_content(self, keywords: list, context: str = None):
        ...
        Ensure the content is well-structured with clear headings and relevant to online diamond store "diamond sutra". Include store's location in blog post with suitable context location:  "Sukhlecho ka chowk, Johri Bazaar, Jaipur". do not give title.
        """
